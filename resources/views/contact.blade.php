<x-guest-layout>
    ...
    <div class="flex flex-row justify-around mt-8">
        <section class="bg-gray-200 rounded-3xl w-1/3 shadow-lg"> {{--contact info--}}
            <div>
        ...
        <section class="bg-gray-200 shadow-lg rounded-3xl w-1/3"> {{--contact form met naam, email, telefoon nummer en korte tekst--}}
            <form class="flex flex-col">
                <label for="fname">Voornaam:</label>
                    <input type="text" id="fname" name="fname" placeholder="Voornaam..." class="rounded-2xl"><br>
