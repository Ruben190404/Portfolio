        ...
        <section class="bg-white shadow-lg w-1/3 h-auto p-6">
            <form class="ml-8" method="post" action="{{route('admin.contacts.store')}}">
                ...
                <label for="fname" class="text-gray-700 text-lg font-medium w-1/2">Voornaam:</label><br>
                    <input type="text" name="fname" placeholder="Voornaam..." class="w-3/4 h-10 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-medium focus:border-indigo-500 focus:outline-none w-1/2"><br>
                <label for="lname" class="text-gray-700 text-lg font-medium w-1/2">Achternaam:</label><br>
                    <input type="text" name="lname" placeholder="Achternaam..." class="w-3/4 h-10 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-medium focus:border-indigo-500 focus:outline-none w-1/2"><br>
                <label for="email" class="text-gray-700 text-lg font-medium w-1/2">Email:</label><br>
                    <input type="email" name="email" placeholder="Email Adres..." class="w-3/4 h-10 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-medium focus:border-indigo-500 focus:outline-none w-1/2"><br>
                <label for="tel" class="text-gray-700 text-lg font-medium w-1/2">Telefoonnummer:</label><br>
                    <input type="text" name="tel" placeholder="Telefoonnummer..." class="w-3/4 h-10 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-medium focus:border-indigo-500 focus:outline-none w-1/2"><br>
